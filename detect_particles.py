...
def yolo_detect(image_path, size):
    os.system("python yolov7/detect.py --weights yolov7/runs/train/yolov7_tiny_particle_multi_res_v3/weights/best.pt --save-txt --no-trace --img-size " + str(size) + " --source " + image_path)
    filename = "runs/detect/exp/labels/" + image_path[:-3] + 'txt'
